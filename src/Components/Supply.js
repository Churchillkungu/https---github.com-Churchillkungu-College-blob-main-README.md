          ...
          {this.fileData()}
                  <Form.Group>
                    ...
                    <div>
                        <h6>
                            <p>
                            In commerce, supply chain management (SCM) is the management of the flow of goods and services[2] between businesses and locations. This can include the movement and storage of raw materials, work-in-process inventory, finished goods, and end to end order fulfilment from the point of origin to the point of consumption. Interconnected, interrelated or interlinked networks, channels and node businesses combine in the provision of products and services required by end customers in a supply chain.[3]
                            </p>
                        </h6>
                    </div>
                    </div>
