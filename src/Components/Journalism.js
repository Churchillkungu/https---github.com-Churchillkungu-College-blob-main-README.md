          ...
          {this.fileData()}
                      <Form.Group>
                        ...
                        <div>
                            <h6>
                                <p>
                                A journalist is a person whose job is to collect news and write about it for newspapers, magazines, television, or radio. Synonyms: reporter, writer, correspondent, newsman or newswoman
                                </p>
                            </h6>
                        </div>
                        </div>
