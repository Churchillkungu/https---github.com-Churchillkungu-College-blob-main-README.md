        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
           ...
           <Container>
             ...
             <div>
                 <h3>Kenya Registered Nursing</h3>
          ...
          {this.fileData()}
                  <Form.Group>
                    ...
                    <div>
                        <h6>
                            <p>
                            Duties and responsibilities at this level will entail: assessing patients and clients and establishing health care needs; planning and implementing nursing care interventions based on patients' needs
                            </p>
                        </h6>
                    </div>
                    </div>
